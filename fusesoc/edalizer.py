...
class Edalizer(object):
    ...
    def __init__(self, vlnv, flags, cores, cache_root, work_root, export_root=None, output_name=None):
        ...
        self.edalize = {
            ...
            'files'        : [],
            'hooks'        : {},
            'name'         : output_name if output_name is not None else top_core.sanitized_name,
            'parameters'   : {},
            'tool_options' : {},
